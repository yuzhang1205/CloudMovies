...
using CloudMovies.Web.Infrastructure.Extensions;
using System.Net;

namespace CloudMovies.Web.Infrastructure.MessageHandlers
{
    public class CloudMoviesAuthHandler:DelegatingHandler
    {
